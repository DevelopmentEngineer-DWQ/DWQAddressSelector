//
//  DWQProvincesCitiesCountiesPickerview.m
//  DWQAddressSelector
//
...
#import "DWQProvincesCitiesCountiesPickerview.h"
#import "DWQAddressManager.h"
#define DWQAddressPickerViewHeight 216

@interface DWQProvincesCitiesCountiesPickerview()<UIPickerViewDataSource,UIPickerViewDelegate>
...
@implementation DWQProvincesCitiesCountiesPickerview
...
- (void)internalConfig {
    ...
    button.frame = CGRectMake(self.frame.size.width - 60, 0, 50, 50);
    button.backgroundColor = [UIColor clearColor];
    button.titleLabel.font = [UIFont systemFontOfSize:16];
    [button setTitleColor:[UIColor colorWithRed:0/255.0 green:122/255.0 blue:255/255.0 alpha:1.0] forState:UIControlStateNormal];
...
- (void)showPickerWithProvinceName:(NSString *)provinceName cityName:(NSString *)cityName countyName:(NSString *)countyName {
   ...
   // NSLog(@"------->选择的城市%ld,%ld,%ld",_firstCurrentIndex,_secondCurrentIndex,_thirdCurrentIndex);
    [self show];
}
...
- (void)show {
    ...
    [UIView animateWithDuration:0.5 animations:^{
        self.pickView.frame = CGRectMake(0, [UIScreen mainScreen].bounds.size.height - DWQAddressPickerViewHeight, self.frame.size.width, DWQAddressPickerViewHeight);
...
- (void)hide {
    _backView.alpha = 0;
    [UIView animateWithDuration:0.5 animations:^{
        self.pickView.frame = CGRectMake(0, [UIScreen mainScreen].bounds.size.height+44, self.frame.size.width, DWQAddressPickerViewHeight);
...
- (UIPickerView*)pickView {
    if (!_pickView) {
        _pickView = [[UIPickerView alloc] initWithFrame:CGRectMake(0, [UIScreen mainScreen].bounds.size.height + 44, self.frame.size.width, DWQAddressPickerViewHeight)];
